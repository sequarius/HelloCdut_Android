...
public class GroupDetailsActivity extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setTitle(
                group.getGroupName() + "(" + group.getAffiliationsCount()
                        + "人)");
        ...
        public View getView(final int position, View convertView,
            ...
            if (position == getCount() - 1) {
                ...
                if (!group.isAllowInvites()
                    ...
                    // if current user is not group admin, hide add/remove btn
                    convertView.setVisibility(View.INVISIBLE);
                } else if (group.getOwner().equals("groupadmin")) {
                    convertView.setVisibility(View.INVISIBLE);
                } else {
                    // 正处于删除模式下,隐藏添加按钮
                    if (isInDeleteMode) {
                ...
                // final String st12 =
                // getResources().getString(R.string.not_delete_myself);
                // final String st13 =
                // getResources().getString(R.string.Are_removed);
                // final String st14 =
                // getResources().getString(R.string.Delete_failed);
                // final String st15 =
                // getResources().getString(R.string.confirm_the_members);
                button.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (isInDeleteMode) {
                    ...
                    public boolean onLongClick(View v) {
                        ...
                        if (group.getOwner().equals(
                            ...
                            Intent intent = new Intent(
                                    GroupDetailsActivity.this,
                                    AlertDialog.class);
                            intent.putExtra("msg", "确认将此用户移入黑名单？");
                            intent.putExtra("cancel", true);
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            if (group.getOwner().equals("groupadmin")) {
                                // if current user is not group admin, hide
                                // add/remove btn
                                exitBtn.setVisibility(View.GONE);
                            }
